...
class GRAlertVC: UIViewController {
    let containerView  = GRAlertContainerView()
    let titleLabel = GRTitleLabel(textalignment: .center, fontsize: 28)
    let messageLabel = GRBodyLabel(textalignment: .center)
    let actionButton = GRButton(backgroundColor: .systemPink, title: "OK")
